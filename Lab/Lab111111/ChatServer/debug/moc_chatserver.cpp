...
template <> constexpr inline auto ChatServer::qt_create_metaobjectdata<qt_meta_tag_ZN10ChatServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'jsonReceived'
        QtMocHelpers::SlotData<void(ServerWorker *, const QJsonObject &)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 }, { QMetaType::QJsonObject, 7 },
        }}),
        // Slot 'userDisconnected'
        QtMocHelpers::SlotData<void(ServerWorker *)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'broadcast'
        QtMocHelpers::SlotData<void(const QJsonObject &, ServerWorker *)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QJsonObject, 10 }, { 0x80000000 | 5, 11 },
        }}),
        // Slot 'broadcast'
        QtMocHelpers::SlotData<void(const QJsonObject &)>(9, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
...
void ChatServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->broadcast((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<ServerWorker*>>(_a[2]))); break;
        case 4: _t->broadcast((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        default: ;
        }
    }
