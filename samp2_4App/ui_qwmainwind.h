...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actName = new QAction(QWMainWind);
        actName->setObjectName("actName");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/creative-commons-by-line.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actName->setIcon(icon11);
        actName->setMenuRole(QAction::MenuRole::NoRole);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actName->setText(QCoreApplication::translate("QWMainWind", "\345\205\263\344\272\216", nullptr));
#if QT_CONFIG(tooltip)
        actName->setToolTip(QCoreApplication::translate("QWMainWind", "\345\205\263\344\272\216\347\224\250\346\210\267", nullptr));
#endif // QT_CONFIG(tooltip)
...
#endif // UI_QWMAINWIND_H
>>>>>>> 944cbf9f21e50e2be7c285e414459730a0cfd2a1
